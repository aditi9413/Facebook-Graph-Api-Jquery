// main document ready function to check if dom is loaded fully or not
 $(document).ready(function() {
     ...
     var myFacebookToken ='EAACEdEose0cBAFc4HWLFx4J0HJlG4R30GkRBnLsutPHMnZBJ9awoGjZC1aOktGKCJX57oi8C5ZAHxLWWiFMj82QQOm6TecCFU6eZAj4oa9GphibiFSby4YQrlk4jMwGJxWQ81CkFtP5dWty770IWZBZBCpkWcxUlA3hEdsaFrFCw1QF3vP7ZBv8xF9PeUhT4ZCXnpEIMor9PUAZDZD';
     ...
     function getProfileInfo() {
         ...
         $.ajax('https://graph.facebook.com/me/?fields=name,email,id,picture,hometown,birthday,gender,first_name&access_token=' + myFacebookToken, {
                 ...
                 success: function(response) {
                     ...
                     $("#myProfilepic").html('<img src="' + response.picture.data.url + '" alt="Smiley face" style="height:90px;width:90px">');
     ...
     var getFeed = function() {
               ...
               //var nextLink = ' ';
        var link='';//https://graph.facebook.com/me/postsfields=id,message,permalink_url,picture,link,name,likes,comments,created_time,full_picture,place&access_token='+myFacebookToken;
